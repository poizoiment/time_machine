    ...
    <div id="rectangel" class="workspace">
        <div class="content">
            <form action="check.php" method="post">
                  ...
                  <label for="nameing"><b>Имя</b></label>
                  <input type="text" placeholder="Введите желаемое имя" name="name" id="name"  required >
                ...
                <div class="container signin">
                  <p>У вас уже есть аккаунт?<a href="whod.php">Войти</a>.</p>
                </div>
              </form>
